    ...
    return (
        ...
        <div className="mt-5 min-h-screen ">
            <div className="flex items-center mb-4">
                <h1  className=" p-3 font-normal text-sm text-slate-500 dark:text-slate-300"> Your Analytics For Promotion: <span className="lg:text-2xl lg:ml-5 dark:text-slate-100 text-md text-slate-700 font-normal">{Promotion.name} </span></h1>
            ...
            <div className="p-4 bg-white dark:bg-slate-950 rounded-lg w-full lg:w-fit mx-auto flex flex-col lg:flex-row items-center gap-5">
                <Sheet >
                    ...
                    <Button className="h-8 dark:bg-slate-200" onClick={() => {performAnalysis(Promotion.id)}}>Analyse</Button>
                    <SheetTrigger className="bg-primary dark:bg-slate-200 text-primary-foreground rounded-lg font-medium text-sm px-3 p-2">Promotion Details</SheetTrigger>
            ...
            <div className="flex-col mt-5">
                ...
                <div className="flex flex-col lg:flex-row justify-around gap-3">
                    <div id="revenue-conversion-rate" className="flex relative dark:bg-slate-950 bg-white rounded-2xl items-center gap-5 p-5 justify-around">
                        ...
                        <div className="rounded-full text-black bg-yellow-100 p-2">
                            <Coins/>
                        </div>
                        
                        <div className="flex-col ">
                            <h2 className="text-3xl mb-3">{revenueConversionRate}%</h2>
                            <h4 className="text-xs font-medium dark:text-slate-300 text-slate-600">Revenue Conversion Rate</h4>
                        </div>
                    </div>
                    <div id="purchase-conversion-rate" className="flex relative dark:bg-slate-950 bg-white rounded-2xl items-center gap-5 p-5 justify-around">
                        <div className="absolute top-2 right-3">
                            <DescribeToolTip>
                                <TooltipTrigger>
                                    <Info size={15}/>
                        ...
                        <div className="rounded-full text-black bg-green-100 p-2">
                            <Wallet/>
                        </div>
                    ...
                    <div id="promotion-conversion-rate" className="flex relative dark:bg-slate-950 bg-white rounded-2xl items-center gap-5 p-5 justify-around">
                        <div className="absolute top-2 right-3">
                            <DescribeToolTip>
                                <TooltipTrigger>
                                    <Info size={15}/>
                        ...
                        <div className="rounded-full text-black bg-blue-100 p-2">
                            <Banknote/>
                        </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-around gap-4">
                    ...
                    <div id="bar-graph-revenue-vs-time-promotion" className="bg-white dark:bg-slate-950 relative rounded-2xl p-6 w-fit my-5">
                        <div className="absolute top-2 right-3">
                            <DescribeToolTip>
                                <TooltipTrigger>
                                    <Info size={15}/>
                        ...
                        <div className="p-4 pt-0">
                            <h3 className="text-slate-500 dark:text-slate-300 font-normal text-lg">Revenue Vs Time Analytics</h3>
                        </div>
                        <BarChart
                        className="text-xs"
                    ...
                    <div className="flex-col justify-around lg:w-1/3 w-full" id="customer segments">
                        <div id="age-cat" className="flex relative dark:bg-slate-950 bg-white my-3 rounded-2xl items-center gap-5 p-5 ">
                            <div className="absolute top-2 right-3">
                                <DescribeToolTip>
                                    <TooltipTrigger>
                                        <Info size={15}/>
                            ...
                            <div className="flex-col ">
                                ...
                                <h4 className="text-xs font-medium dark:text-slate-300 text-slate-600">Age Criteria Success Rate - {convertToTitleCase(Promotion.criteria.ageCategory)}</h4>
                            </div>
                        </div>
                        <div id="gender" className="flex relative dark:bg-slate-950 bg-white my-3 rounded-2xl items-center gap-5 p-5 ">
                            <div className="absolute top-2 right-3">
                                <DescribeToolTip>
                                    <TooltipTrigger>
                                        <Info size={15}/>
                            ...
                            <div className="flex-col ">
                                ...
                                <h4 className="text-xs font-medium dark:text-slate-300 text-slate-600">Gender Criteria Success Rate - {convertToTitleCase(Promotion.criteria.gender)}</h4>
                            </div>
                        </div>
                        <div id="marital-status" className="flex relative dark:bg-slate-950 bg-white my-3 rounded-2xl items-center gap-5 p-5 ">
                            <div className="absolute top-2 right-3">
                                <DescribeToolTip>
                                    <TooltipTrigger>
                                        <Info size={15}/>
                            ...
                            <div className="flex-col ">
                                ...
                                <h4 className="text-xs font-medium dark:text-slate-300 text-slate-600">Marital Status Criteria Success Rate - {convertToTitleCase(Promotion.criteria.maritalStatus)}</h4>
                            </div>
                        </div>
                    </div>
                </div>
